...
PY
  ...
  # Evaluation rule for dry_run_v1
...
record = {
  ...
  "output": {
    "raw_response": ${{"__RAW__": ""}}  # placeholder replaced below
  },
  "evaluation": {
    "status": "$status",
...
# Insert raw response safely
record["output"]["raw_response"] = """$response"""
